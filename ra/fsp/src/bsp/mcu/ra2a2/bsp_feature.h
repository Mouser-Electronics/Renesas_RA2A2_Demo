...
#define BSP_FEATURE_ADC_TSN_SLOPE                         (-3300LL)         // Typical slope for the temperature sensor, in uV/degC.
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                   (0x0FUL)          // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_AGT_AGT_CHANNEL_COUNT                 (8U)              // Number of channels for only AGT (not AGTW) peripherals.
...
#define BSP_FEATURE_AGT_VALID_CHANNEL_MASK                (0xFFUL)          // A mask of all valid AGTx channels.
...
#define BSP_FEATURE_BSP_MSTP_GPT_MSTPD5_MAX_CH            (3UL)             // Largest channel number associated with GPT on the MSTPCRD.MSTPD5 field on this MCU.
...
#define BSP_FEATURE_CGC_HAS_OSTDCSE                       (1UL)             // OSTDCSE register is available.
...
#define BSP_FEATURE_CGC_PLL_OUT_MAX_HZ                    (12795904UL)      // Maximum output frequency for PLL unit 1.
#define BSP_FEATURE_CGC_PLL_OUT_MIN_HZ                    (11993088UL)      // Minimum output frequency for PLL unit 1.
...
#define BSP_FEATURE_CGC_PLL_SRC_MAX_HZ                    (32768UL)         // Maximum input frequency for PLL unit 1.
#define BSP_FEATURE_CGC_PLL_SRC_MIN_HZ                    (32768UL)         // Minimum output frequency for PLL unit 1.
...
#define BSP_FEATURE_CGC_PLLCCR_TYPE                       (4UL)             // Indicates the type of PLLCCR register and PLL.
#define BSP_FEATURE_CGC_PLLCCR_VCO_MAX_HZ                 (13000000UL)      // PLL VCO maximum frequency.
...
#define BSP_FEATURE_FLASH_LP_CF_DUAL_BANK_START           (0x00040000UL)    // Start address of the second bank.
...
#define BSP_FEATURE_FLASH_LP_FLASH_CLOCK_SRC              ((fsp_priv_clock_t) FSP_PRIV_CLOCK_ICLK)  // Clock source for the flash memory.
#define BSP_FEATURE_FLASH_LP_SUPPORTS_DUAL_BANK           (1UL)             // Dual bank is supported for FLASH_LP.
...
#define BSP_FEATURE_ICU_FIXED_IELSR_COUNT                 (36UL)            // Number of IELSRn registers that have a fixed event source.
...
#define BSP_FEATURE_ICU_IRQ_CHANNELS_MASK                 (0x0FFFUL)        // Mask of available IRQ control registers.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                        (0x000001FFFBFD0FFFULL)   // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_LPM_RTC_REGISTER_CLOCK_DISABLE        (1UL)             // RTC registers' clock should be disabled for additional power savings in LPM.
...
#define BSP_FEATURE_LPM_SNZREQCR_MASK                     (0x73800FFFULL)   // Mask of valid bits for the SNZREQCRn registers.
...
#define BSP_FEATURE_LVD_EXLVD_STABILIZATION_TIME_US       (500UL)           // Detection delay time for EXLVD pin input.
#define BSP_FEATURE_LVD_EXLVDVBAT_HI_THRESHOLD            (LVD_THRESHOLD_EXLVDVBAT_LEVEL_3_1V)  // External LVD for VBAT reference voltage high threshold.
#define BSP_FEATURE_LVD_EXLVDVBAT_LOW_THRESHOLD           (LVD_THRESHOLD_EXLVDVBAT_LEVEL_2_2V)  // External LVD for VBAT reference voltage low threshold.
#define BSP_FEATURE_LVD_EXLVDVRTC_HI_THRESHOLD            (LVD_THRESHOLD_LVDVRTC_LEVEL_2_8V)    // External LVD for VRTC reference voltage high threshold.
#define BSP_FEATURE_LVD_EXLVDVRTC_LOW_THRESHOLD           (LVD_THRESHOLD_LVDVRTC_LEVEL_2_2V)    // External LVD for VRTC reference voltage low threshold.
#define BSP_FEATURE_LVD_HAS_DIGITAL_FILTER                (0UL)             // Digital input filtering is available.
#define BSP_FEATURE_LVD_HAS_EXT_MONITOR                   (1UL)             // Voltage monitoring is available for an external power supply via pin.
...
#define BSP_FEATURE_LVD_VBAT_STABILIZATION_TIME_US        (500UL)           // Detection delay time for EXLVDVBAT pin input.
...
#define BSP_FEATURE_LVD_VRTC_STABILIZATION_TIME_US        (500UL)           // Detection delay time for VRTC pin input.

#define BSP_FEATURE_MACL_SUPPORTED                        (1UL)             // On-chip multiplier and multiply-accumulator is available.
...
#define BSP_FEATURE_RSIP_AES_B_SUPPORTED                  (1UL)             // The device supports cryptography using AES_B.
...
#define BSP_FEATURE_RTC_IS_IRTC                           (1UL)             // RTC has a separate power domain (VRTC) for the sub-clock oscillator and RTC peripheral.
...
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS            (0x020FUL)        // Mask of channels with data compare match (DCCR) available.
#define BSP_FEATURE_SCI_CHANNELS                          (0x020FUL)        // Mask of available SCI channels.
...
#define BSP_FEATURE_SLCDC_CONTRAST_MAX                    (22UL)            // Maximum contrast index for standard bias methods.
#define BSP_FEATURE_SLCDC_CONTRAST_MAX_4BIAS              (9UL)             // Maximum contrast index for 1/4 bias method.
...
#define BSP_FEATURE_SLCDC_HAS_VL1SEL                      (1UL)             // Internal voltage generator can be used as the LCD reference voltage.
#define BSP_FEATURE_SLCDC_HAS_VLCD_MDSET2                 (1UL)             // VLCD register has MDSET2.
#define BSP_FEATURE_SLCDC_MAX_NUM_SEG                     (44UL)            // Maximum index of supported segment registers.
