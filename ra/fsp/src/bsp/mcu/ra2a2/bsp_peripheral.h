...
#define BSP_PERIPHERAL_AGT_CHANNEL_MASK          (0xFFU)
...
#define BSP_PERIPHERAL_GPT_CHANNEL_MASK          (0x3F0U)
...
#define BSP_PERIPHERAL_ICU_EXT_IRQ_CHANNEL_MASK  (0xFFFU)
...
#define BSP_PERIPHERAL_IRTC_PRESENT              (1)
...
#define BSP_PERIPHERAL_MACL_PRESENT              (1)
...
#define BSP_PERIPHERAL_PORT_CHANNEL_MASK         (0x7FU)
...
#define BSP_PERIPHERAL_SDADC_B_PRESENT           (1)
#define BSP_PERIPHERAL_SDADC_B_CHANNEL_MASK      (0x1U)
